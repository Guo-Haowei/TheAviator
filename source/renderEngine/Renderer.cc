...
Renderer::Renderer()
{
    ...
    glTexImage2D(
        GL_TEXTURE_2D, 0, GL_RGBA, ACTUAL_WIDTH, ACTUAL_HEIGHT, 0, GL_RGBA, GL_UNSIGNED_BYTE, NULL);
    ...
    glTexImage2D(
        GL_TEXTURE_2D, 0, GL_RGB16F, ACTUAL_WIDTH, ACTUAL_HEIGHT, 0, GL_RGB, GL_FLOAT, NULL);
    glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MIN_FILTER, GL_NEAREST);
    glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MAG_FILTER, GL_NEAREST);
