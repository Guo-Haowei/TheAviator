...
Airplane::Airplane()
    ...
    , windShield(
          Geometry::cube, glm::vec3(0.5f, 2.7f, 0.0f), white, glm::vec3(0.3f, 1.5f, 2.0f), 0.3f)
    ,
    ...
    , wheelProtectionL(
          Geometry::cube, glm::vec3(2.5f, -2.0f, -2.5f), red, glm::vec3(3.0f, 1.5f, 1.0f))
...
void Airplane::update()
{
    ...
    else
    {
        ...
        float targetX = Maths::clamp(
            MouseManager::getX(), -1.0f, 1.0f, -AIRPLANE::AMPWIDTH, -0.7f * AIRPLANE::AMPWIDTH);
        float targetY = Maths::clamp(MouseManager::getY(),
                                     -0.75f,
                                     0.75f,
                                     AIRPLANE::Y - AIRPLANE::AMPHEIGHT,
                                     AIRPLANE::Y + AIRPLANE::AMPHEIGHT);
