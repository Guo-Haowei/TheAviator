...
RawModel* createCockpit() {
  glm::vec3 vert0(4, 5, 5);
  glm::vec3 vert1(4, 5, -5);
  glm::vec3 vert2(4, -5, 5);
  glm::vec3 vert3(4, -5, -5);
  glm::vec3 vert4(-4, 4, -3);
  glm::vec3 vert5(-4, 4, 3);
  glm::vec3 vert6(-4, -2, -3);
  glm::vec3 vert7(-4, -2, 3);
