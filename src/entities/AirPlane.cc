...
AirPlane::AirPlane(): 
  ...
  wheelProtectionR(Geometry::cube, glm::vec3(5.0f, -3.5f, 4.0f), glm::vec3(0.0f), red, glm::vec3(3.0f, 1.5f, 1.0f)),
  wheelProtectionL(Geometry::cube, glm::vec3(5.0f, -3.5f, -4.0f), glm::vec3(0.0f), red, glm::vec3(3.0f, 1.5f, 1.0f)),
  tireR(Geometry::cube, glm::vec3(5.0f, -4.8f, 4.0f), glm::vec3(0.0f), brownDark, glm::vec3(2.4f, 2.4f, 0.4f)),
  tireL(Geometry::cube, glm::vec3(5.0f, -4.8f, -4.0f), glm::vec3(0.0f), brownDark, glm::vec3(2.4f, 2.4f, 0.4f)),
  wheelAxis(Geometry::cube, glm::vec3(5.0, -4.8f, 0.0f), glm::vec3(0.0f), brown, glm::vec3(1.0f, 1.0f, 5.0f)),
  suspension(Geometry::cube, glm::vec3(-7.0f, 0.0f, 0.0f), glm::vec3(0.0f, 0.0f, -0.3f), red, glm::vec3(0.4f, 2.0f, 0.4f)),
  wheelB(Geometry::cube, glm::vec3(-7.5f, -1.8f, 0.0f), glm::vec3(0.0f), brownDark, glm::vec3(1.2f, 1.2f, 0.2f)),
  wheelAxisB(Geometry::cube, glm::vec3(-7.5f, -1.8f, 0.0f), glm::vec3(0.0f), brown, glm::vec3(0.6f, 0.6f, 0.4f))
{
...
void AirPlane::update() {
  ...
  // for (int i = 0; i < components.size(); ++i) {
  //   components[i]->changePosition(glm::vec3(0.1f, 0.0f, 0.0f));
  // }
}